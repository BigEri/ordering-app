...
export const MESSAGES: Record<Locale, Record<string, string>> = {
  cs: {
    ...
    "bill.split.who": "Jak chcete platit?",
    "bill.split.together": "Dohromady",
    "bill.split.separate": "Zvlášť",
    "bill.split.pickHint": "Označte, co platí první host. Další zaplatí zbytek stejným způsobem.",
    "bill.split.boardTitle": "Rozdělit účet",
    "bill.split.boardSubtitle": "Klepněte vlevo a položka se přesune k platbě. Klepnutím vpravo ji vrátíte.",
    "bill.split.leftTitle": "Na účtu",
    "bill.split.rightTitle": "Vybrané",
    "bill.split.leftEmpty": "Všechno je vpravo.",
    "bill.split.rightEmpty": "Zatím nic. Klepněte na položku vlevo.",
    "bill.split.back": "Zpět na účet",
    "bill.split.paySelected": "Zaplatit vybrané",
    "bill.split.needItems": "Vyberte položky, které chcete zaplatit.",
    "bill.split.nextGuestBody": "Tento host zaplatil. Další host teď může vybrat položky.",
    "bill.split.nextGuestContinue": "Pokračovat v platbě",
    ...
    "bill.xpay.title": "Zaplatit kartou",
    "bill.xpay.subtitle": "Naskenujte QR kód telefonem.",
    "bill.xpay.hint": "Visa, Mastercard, Apple Pay nebo Google Pay na vašem telefonu. Číslo karty do tabletu nezadávejte.",
    "bill.xpay.loading": "Připravuji QR kód…",
    "bill.xpay.failedTitle": "Platba neproběhla",
    "bill.xpay.failedBody": "Zkuste to znovu, nebo přivolejte obsluhu.",
    "bill.xpay.tillPending": "Platba prošla. Uzavření účtu v pokladně se ještě dokončuje.",
    "bill.xpay.tipMissing": "V Dotykačce účet zůstal bez dýška. Kartou se strhla částka včetně spropitného.",
    "bill.xpay.sandboxHint": "Sandbox v CZK (testovací stránka Tableflow, peníze se nestrhnou).",
    "bill.xpay.nexiSandboxHint": "Otevře se opravdová Nexi stránka (sandbox, testovací karty, nic se nestrhne). Na tabletu zůstává Kč z pokladny.",
    "bill.xpay.nexiSandboxAmount": "Na telefonu: {{eur}}",
    ...
    "paid.modal.bodyWithTip": "Kartou zaplaceno {{total}} včetně spropitného {{tip}}.",
    ...
    "admin.devices.editTableHint": "Změní se ID stolu v pokladně i zobrazený název. Restaurace zůstane stejná.",
    ...
    "admin.devices.pairKioskTableFromDoty": "Stůl z pokladny",
    "admin.devices.pairKioskTablePlaceholder": "— vyberte stůl —",
    "admin.devices.pairKioskTableManualOption": "Zadat ID a název ručně…",
    "admin.devices.pairKioskNoTables": "Z pokladny se nepodařilo načíst žádné stoly. Zkontrolujte propojení, nebo zadejte stůl ručně níže.",
    ...
    "admin.devices.pairKioskTablesErr": "Nepodařilo se načíst stoly z pokladny. Zkuste to prosím znovu.",
  ...
  en: {
    ...
    "bill.split.who": "How do you want to pay?",
    "bill.split.together": "Together",
    "bill.split.separate": "Split",
    "bill.split.pickHint": "Tap what the first guest is paying. The others pay the rest the same way.",
    "bill.split.boardTitle": "Split the bill",
    "bill.split.boardSubtitle": "Tap left to add an item to pay. Tap right to put it back.",
    "bill.split.leftTitle": "On the bill",
    "bill.split.rightTitle": "Selected",
    "bill.split.leftEmpty": "Everything is on the right.",
    "bill.split.rightEmpty": "Nothing yet. Tap an item on the left.",
    "bill.split.back": "Back to bill",
    "bill.split.paySelected": "Pay selected",
    "bill.split.needItems": "Select the items you want to pay for.",
    "bill.split.nextGuestBody": "This guest has paid. The next guest can pick items now.",
    "bill.split.nextGuestContinue": "Continue paying",
    ...
    "bill.xpay.title": "Pay by card",
    "bill.xpay.subtitle": "Scan the QR code with your phone.",
    "bill.xpay.hint": "Visa, Mastercard, Apple Pay or Google Pay on your phone. Do not type a card number on the tablet.",
    "bill.xpay.loading": "Preparing QR code…",
    "bill.xpay.failedTitle": "Payment did not go through",
    "bill.xpay.failedBody": "Please try again, or call staff.",
    "bill.xpay.tillPending": "Payment received. The till is still closing the bill.",
    "bill.xpay.tipMissing": "The till bill was closed without the tip. The card was charged the amount including the tip.",
    "bill.xpay.sandboxHint": "CZK sandbox (Tableflow test page, no real charge).",
    "bill.xpay.nexiSandboxHint": "This opens the real Nexi checkout (sandbox, test cards, no charge). The tablet still shows CZK from the till.",
    "bill.xpay.nexiSandboxAmount": "On the phone: {{eur}}",
    ...
    "paid.modal.bodyWithTip": "Card charged {{total}} including a {{tip}} tip.",
    ...
    "admin.devices.editTableHint": "Updates the till table ID and the display label. The restaurant stays the same.",
    ...
    "admin.devices.pairKioskTableFromDoty": "Table from till",
    "admin.devices.pairKioskTablePlaceholder": "— select table —",
    "admin.devices.pairKioskTableManualOption": "Enter ID and label manually…",
    "admin.devices.pairKioskNoTables": "No tables from the till — check POS connection or enter the table manually below.",
    ...
    "admin.devices.pairKioskTablesErr": "Could not load tables from the till.",
  ...
  ko: {
    ...
    "bill.split.who": "어떻게 결제할까요?",
    "bill.split.together": "함께",
    "bill.split.separate": "따로",
    "bill.split.pickHint": "첫 번째 손님이 결제할 항목을 고르세요. 나머지는 같은 방식으로 결제합니다.",
    "bill.split.boardTitle": "계산서 나누기",
    "bill.split.boardSubtitle": "왼쪽을 누르면 결제 항목으로 이동합니다. 오른쪽을 누르면 되돌립니다.",
    "bill.split.leftTitle": "계산서",
    "bill.split.rightTitle": "선택됨",
    "bill.split.leftEmpty": "모두 오른쪽으로 옮겼습니다.",
    "bill.split.rightEmpty": "아직 없습니다. 왼쪽 항목을 누르세요.",
    "bill.split.back": "계산서로",
    "bill.split.paySelected": "선택한 항목 결제",
    "bill.split.needItems": "결제할 항목을 선택하세요.",
    "bill.split.nextGuestBody": "이 손님 결제가 끝났습니다. 다음 손님이 항목을 고를 수 있습니다.",
    "bill.split.nextGuestContinue": "결제 계속",
    "bill.tipAmount": "팁 금액",
    "bill.total": "합계",
    "bill.pay": "결제",
    ...
    "bill.xpay.title": "카드 결제",
    "bill.xpay.subtitle": "휴대폰으로 QR 코드를 스캔하세요.",
    "bill.xpay.hint": "Visa, Mastercard, Apple Pay 또는 Google Pay로 휴대폰에서 결제하세요. 태블릿에 카드 번호를 입력하지 마세요.",
    "bill.xpay.loading": "QR 코드를 준비하는 중…",
    "bill.xpay.failedTitle": "결제가 완료되지 않았습니다",
    "bill.xpay.failedBody": "다시 시도하거나 직원을 호출하세요.",
    "bill.xpay.tillPending": "결제는 접수되었습니다. 포스기에서 계산서 마감을 아직 완료하는 중입니다.",
    "bill.xpay.tipMissing": "포스 계산서에는 팁이 없습니다. 카드에서는 팁이 포함된 금액이 결제되었습니다.",
    "bill.xpay.sandboxHint": "CZK 샌드박스 (Tableflow 테스트 페이지, 실제 결제가 아닙니다).",
    "bill.xpay.nexiSandboxHint": "실제 Nexi 결제 페이지가 열립니다 (샌드박스, 테스트 카드, 실제 청구 없음). 태블릿에는 포스 금액(CZK)이 그대로 표시됩니다.",
    "bill.xpay.nexiSandboxAmount": "휴대폰: {{eur}}",
    ...
    "paid.modal.bodyWithTip": "카드로 {{total}}이 결제되었습니다. 팁 {{tip}} 포함.",
    "paid.modal.close": "닫기",
